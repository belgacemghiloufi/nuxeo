...
public class ConfigurationChecker {
    ...
    public static final int PARAM_POLICY_DEFAULT_DELAY_IN_MS = 5000;

    public static final int PARAM_RETRY_POLICY_DEFAULT_RETRIES = 20;
    ...
    /**
     * Check the java version present in system properties compared to compliant ones.
     */
    ...
    /**
     * Check server paths; warn if deprecated paths exist.
     */
    protected void checkPaths(ConfigurationHolder configHolder) throws ConfigurationException {
        ...
        if (Files.exists(badInstanceClid) && !dataPath.startsWith(badInstanceClid)) {
